...
\cvlabel{面向真实用户与社会场景的人本智能系统研究}，将 HCI 实证研究与机器学习模型结合，关注 AI 如何被真实用户理解、评估与使用。
\begin{itemize}[leftmargin=*]
  \item \cvlabel{社会智能与可靠 AI}：面向心理健康社区、算法公平、交通预测等场景，构建可解释、可评估、可部署的方法。
  \item \cvlabel{AI 辅助编程教育}：研究学生如何借助 AI 学习编程，以及认知脚手架、认知卸载与验证负担的形成机制。
  \item \cvlabel{AI 介导沟通、信任与隐私}：研究 AI 写作、情感表达、用户同意边界与隐私选择中的信任机制。
\end{itemize}
\noindent\cvlabel{关键词：} Human-Centered AI；HCI；LLMs；GNN；AI 教育；社会计算；算法公平；隐私与信任。

%------------------------
\section*{研究亮点}
\begin{itemize}[leftmargin=*]
    \item \cvlabel{代表性成果：} 以第一作者/通讯作者 发表包括 ACL、ICML、CHI、FSE、WWW、AAAI、IJCAI 等 CCF A 类会议论文 9 篇，以及 Q1 / 中科院 1 区 Top 期刊论文 4 篇；其中 3 篇被 CHI 2026 录用，1 篇获 ACM CHI 2026 荣誉提名奖（Honourable Mention Award）。
...
\noindent
\textbf{计算机科学博士} \hfill 2022年9月 -- 2026年6月\\
\textbf{马来亚大学} (Universiti Malaya, QS 58)，马来西亚吉隆坡 \\
研究方向：Human-Centered AI、人机交互、AI 教育与情感计算 \\
...
\begin{enumerate}[label={[C\arabic*]}]
    ...
    \pubitem{Liu D., \textbf{Fan, G.}$^*$, Sabri A.Q.M., Pan L. (2026). Audit-of-Audits for the Web: Bayesian Meta-Evaluation that Yields Interval-Valued, Threshold-Aligned Fairness Claims. \textit{WWW 2026}. \textbf{CCF A}}
...
\begin{enumerate}[label={[C\arabic*]}, resume]
    ...
    \pubitem{Liu, D., Pan, L., Zhang, R., Sabri, A.Q.M, \textbf{Fan, G.}$^*$,. (2026). Consent Boundaries by Play: A CI-Grounded Micro-Game for Eliciting Stable Preferences and Diagnosing Opt-Out Friction in Web Consent. In Proceedings of the 2026 European Conference on Computer-Supported Cooperative Work (ECSCW 2026). EUSSET. \textbf{CCF B}}
...
\noindent
\textbf{教学获奖：太原科技大学高校教师教学创新大赛：一等奖；
山西省高校教师教学创新大赛：省三等奖。}
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{ICML 2026} -- 人工智能顶会 (CCF A)
